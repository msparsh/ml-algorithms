...
def validation_split(X, y, validation_size=0):
    ...
    Args:
        ...
        validation_size (float): Proportion of the dataset to include in the validation split (between 0 and 1).
...
# Stuff to use in future : simultaneous_shuffle(X,y) and random_sample(X, y, sample_size)